...
public class Z_Rfc_Create_Etail_Customer_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setT_Return_Tab(hmh.sap.rfc.util.Zbdcmsgcoll_RfcType_List T_Return_Tab) {
        baseTypeData().setElementValue(4, T_Return_Tab);
    }
    ...
    public MetaData metadataZ_Rfc_Create_Etail_Customer_Output() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Z_Rfc_Create_Etail_Customer_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Z_Rfc_Create_Etail_Customer_Output parent) {
            this.parent = parent;
