...
public class Z_Rfc_Get_Material_Detail_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setI_Subscription(hmh.sap.rfc.ZsubsType[] I_Subscription) {
        baseTypeData().setElementValue(1, new hmh.sap.rfc.util.ZsubsType_List());
    ...
    public void setI_Components(hmh.sap.rfc.util.ZcompType_List I_Components) {
        baseTypeData().setElementValue(6, I_Components);
    }
    ...
    public hmh.sap.rfc.util.Zident_CodeType_List get_as_listI_Isbn() {
        return (hmh.sap.rfc.util.Zident_CodeType_List)baseTypeData().getElementValue(4);
    }

    
    public hmh.sap.rfc.Zmaterial_DetailsType[] getI_Material_Detail() {
        hmh.sap.rfc.util.Zmaterial_DetailsType_List i$ = (hmh.sap.rfc.util.Zmaterial_DetailsType_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
        return  i$.toArrayZmaterial_DetailsType();
    }

    
    public java.lang.String getReturn_Status_Code() {
        return (java.lang.String)baseTypeData().getElementValueAsString(0);
    }

    
    public void setI_Material_Detail(hmh.sap.rfc.Zmaterial_DetailsType[] I_Material_Detail) {
        baseTypeData().setElementValue(3, new hmh.sap.rfc.util.Zmaterial_DetailsType_List());
    ...
    public void setI_Isbn(hmh.sap.rfc.util.Zident_CodeType_List I_Isbn) {
        baseTypeData().setElementValue(4, I_Isbn);
    }

    
    public void setI_Components(hmh.sap.rfc.ZcompType[] I_Components) {
        baseTypeData().setElementValue(6, new hmh.sap.rfc.util.ZcompType_List());
    ...
    public void setI_Material_Detail(hmh.sap.rfc.util.Zmaterial_DetailsType_List I_Material_Detail) {
        baseTypeData().setElementValue(3, I_Material_Detail);
    }

    
    public hmh.sap.rfc.util.Zmaterial_DetailsType_List get_as_listI_Material_Detail() {
        return (hmh.sap.rfc.util.Zmaterial_DetailsType_List)baseTypeData().getElementValue(3);
    }

    
    public void setReturn_Status_Code(java.lang.String Return_Status_Code) {
        baseTypeData().setElementValue(0, Return_Status_Code);
    }

    
    public hmh.sap.rfc.Zident_CodeType[] getI_Isbn() {
        hmh.sap.rfc.util.Zident_CodeType_List i$ = (hmh.sap.rfc.util.Zident_CodeType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.ZsubsType[] getI_Subscription() {
        hmh.sap.rfc.util.ZsubsType_List i$ = (hmh.sap.rfc.util.ZsubsType_List)baseTypeData().getElementValue(1);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.ZsubsType_List get_as_listI_Subscription() {
        return (hmh.sap.rfc.util.ZsubsType_List)baseTypeData().getElementValue(1);
    }

    
    public void setI_Isbn(hmh.sap.rfc.Zident_CodeType[] I_Isbn) {
        baseTypeData().setElementValue(4, new hmh.sap.rfc.util.Zident_CodeType_List());
    ...
    public void setI_Subscription(hmh.sap.rfc.util.ZsubsType_List I_Subscription) {
        baseTypeData().setElementValue(1, I_Subscription);
    }

    
    public void setI_Material_Number(hmh.sap.rfc.util.ZmatnrType_List I_Material_Number) {
        baseTypeData().setElementValue(2, I_Material_Number);
    }

    
    public MetaData metadataZ_Rfc_Get_Material_Detail_Output() {
        return metadata;
    }
    ...
    public hmh.sap.rfc.ZcompType[] getI_Components() {
        hmh.sap.rfc.util.ZcompType_List i$ = (hmh.sap.rfc.util.ZcompType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
    ...
    public void setI_Error_Msgs(hmh.sap.rfc.util.Zbdcmsgcoll_RfcType_List I_Error_Msgs) {
        baseTypeData().setElementValue(5, I_Error_Msgs);
    }

    
    public hmh.sap.rfc.util.ZcompType_List get_as_listI_Components() {
        return (hmh.sap.rfc.util.ZcompType_List)baseTypeData().getElementValue(6);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Z_Rfc_Get_Material_Detail_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Z_Rfc_Get_Material_Detail_Output parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getReturn_Status_Code() {
