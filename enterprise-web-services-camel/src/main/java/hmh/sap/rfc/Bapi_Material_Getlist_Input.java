...
public class Bapi_Material_Getlist_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public hmh.sap.rfc.BapimatrasoType[] getSalesorganisationselection() {
        hmh.sap.rfc.util.BapimatrasoType_List i$ = (hmh.sap.rfc.util.BapimatrasoType_List)baseTypeData().getElementValue(2);
    ...
    public void setMatnrlist(hmh.sap.rfc.util.BapimatlstType_List Matnrlist) {
        baseTypeData().setElementValue(6, Matnrlist);
    }

    
    public int getMaxrows() {
        return baseTypeData().getElementValueAsInt(0);
    }

    
    public hmh.sap.rfc.util.BapimatrasoType_List get_as_listSalesorganisationselection() {
        return (hmh.sap.rfc.util.BapimatrasoType_List)baseTypeData().getElementValue(2);
    }

    
    public void setMaterialshortdescsel(hmh.sap.rfc.BapimatrasType[] Materialshortdescsel) {
        baseTypeData().setElementValue(7, new hmh.sap.rfc.util.BapimatrasType_List());
    ...
    public void setManufacturerpartnumb(hmh.sap.rfc.util.BapimatmfrpnType_List Manufacturerpartnumb) {
        baseTypeData().setElementValue(8, Manufacturerpartnumb);
    }

    
    public hmh.sap.rfc.Bapiret2Type[] getReturn() {
        hmh.sap.rfc.util.Bapiret2Type_List i$ = (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(3);
        if ( i$ == null){return null;}
    ...
    public void setStoragelocationselect(hmh.sap.rfc.util.BapimatralType_List Storagelocationselect) {
        baseTypeData().setElementValue(1, Storagelocationselect);
    }

    
    public void setMatnrselection(hmh.sap.rfc.BapimatramType[] Matnrselection) {
        baseTypeData().setElementValue(5, new hmh.sap.rfc.util.BapimatramType_List());
    ...
    public hmh.sap.rfc.BapimatrasType[] getMaterialshortdescsel() {
        hmh.sap.rfc.util.BapimatrasType_List i$ = (hmh.sap.rfc.util.BapimatrasType_List)baseTypeData().getElementValue(7);
        if ( i$ == null){return null;}
    ...
    public void setMatnrlist(hmh.sap.rfc.BapimatlstType[] Matnrlist) {
        baseTypeData().setElementValue(6, new hmh.sap.rfc.util.BapimatlstType_List());
    ...
    public void setMaxrows(int Maxrows) {
        baseTypeData().setElementValue(0, Maxrows);
    }

    
    public hmh.sap.rfc.BapimatramType[] getMatnrselection() {
        hmh.sap.rfc.util.BapimatramType_List i$ = (hmh.sap.rfc.util.BapimatramType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
    ...
    public void setDistributionchannelselection(hmh.sap.rfc.BapimatradcType[] Distributionchannelselection) {
        baseTypeData().setElementValue(9, new hmh.sap.rfc.util.BapimatradcType_List());
    ...
    public hmh.sap.rfc.BapimatrawType[] getPlantselection() {
        hmh.sap.rfc.util.BapimatrawType_List i$ = (hmh.sap.rfc.util.BapimatrawType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapimatrawType_List get_as_listPlantselection() {
        return (hmh.sap.rfc.util.BapimatrawType_List)baseTypeData().getElementValue(4);
    }

    
    public hmh.sap.rfc.util.BapimatramType_List get_as_listMatnrselection() {
        return (hmh.sap.rfc.util.BapimatramType_List)baseTypeData().getElementValue(5);
    }

    
    public hmh.sap.rfc.util.Bapiret2Type_List get_as_listReturn() {
        return (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(3);
    }

    
    public void setDistributionchannelselection(hmh.sap.rfc.util.BapimatradcType_List Distributionchannelselection) {
        baseTypeData().setElementValue(9, Distributionchannelselection);
    }

    
    public void setStoragelocationselect(hmh.sap.rfc.BapimatralType[] Storagelocationselect) {
        baseTypeData().setElementValue(1, new hmh.sap.rfc.util.BapimatralType_List());
    ...
    public hmh.sap.rfc.BapimatralType[] getStoragelocationselect() {
        hmh.sap.rfc.util.BapimatralType_List i$ = (hmh.sap.rfc.util.BapimatralType_List)baseTypeData().getElementValue(1);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapimatrasType_List get_as_listMaterialshortdescsel() {
        return (hmh.sap.rfc.util.BapimatrasType_List)baseTypeData().getElementValue(7);
    }

    
    public void setPlantselection(hmh.sap.rfc.BapimatrawType[] Plantselection) {
        baseTypeData().setElementValue(4, new hmh.sap.rfc.util.BapimatrawType_List());
    ...
    public hmh.sap.rfc.BapimatradcType[] getDistributionchannelselection() {
        hmh.sap.rfc.util.BapimatradcType_List i$ = (hmh.sap.rfc.util.BapimatradcType_List)baseTypeData().getElementValue(9);
        if ( i$ == null){return null;}
    ...
    public void setSalesorganisationselection(hmh.sap.rfc.util.BapimatrasoType_List Salesorganisationselection) {
        baseTypeData().setElementValue(2, Salesorganisationselection);
    }

    
    public hmh.sap.rfc.util.BapimatmfrpnType_List get_as_listManufacturerpartnumb() {
        return (hmh.sap.rfc.util.BapimatmfrpnType_List)baseTypeData().getElementValue(8);
    }

    
    public MetaData metadataBapi_Material_Getlist_Input() {
        return metadata;
    }

    
    public void setMaterialshortdescsel(hmh.sap.rfc.util.BapimatrasType_List Materialshortdescsel) {
        baseTypeData().setElementValue(7, Materialshortdescsel);
    }

    
    public hmh.sap.rfc.BapimatlstType[] getMatnrlist() {
        hmh.sap.rfc.util.BapimatlstType_List i$ = (hmh.sap.rfc.util.BapimatlstType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapimatmfrpnType[] getManufacturerpartnumb() {
        hmh.sap.rfc.util.BapimatmfrpnType_List i$ = (hmh.sap.rfc.util.BapimatmfrpnType_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public void setPlantselection(hmh.sap.rfc.util.BapimatrawType_List Plantselection) {
        baseTypeData().setElementValue(4, Plantselection);
    }

    
    public hmh.sap.rfc.util.BapimatradcType_List get_as_listDistributionchannelselection() {
        return (hmh.sap.rfc.util.BapimatradcType_List)baseTypeData().getElementValue(9);
    }

    
    public void setManufacturerpartnumb(hmh.sap.rfc.BapimatmfrpnType[] Manufacturerpartnumb) {
        baseTypeData().setElementValue(8, new hmh.sap.rfc.util.BapimatmfrpnType_List());
    ...
    public hmh.sap.rfc.util.BapimatralType_List get_as_listStoragelocationselect() {
        return (hmh.sap.rfc.util.BapimatralType_List)baseTypeData().getElementValue(1);
    }

    
    public void setReturn(hmh.sap.rfc.Bapiret2Type[] Return) {
        baseTypeData().setElementValue(3, new hmh.sap.rfc.util.Bapiret2Type_List());
    ...
    public hmh.sap.rfc.util.BapimatlstType_List get_as_listMatnrlist() {
        return (hmh.sap.rfc.util.BapimatlstType_List)baseTypeData().getElementValue(6);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Bapi_Material_Getlist_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Bapi_Material_Getlist_Input parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getMaxrows() {
