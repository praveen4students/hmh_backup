...
public class ZvrelationType extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    private  ZvrelationType.MetaData metadata = new MetaData(this) ;
    ...
    protected  ZvrelationType (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  ZvrelationType () {
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  ZvrelationType parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (ZvrelationType parent) {
            this.parent = parent;
