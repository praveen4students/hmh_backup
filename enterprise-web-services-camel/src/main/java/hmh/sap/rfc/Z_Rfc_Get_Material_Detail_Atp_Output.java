...
public class Z_Rfc_Get_Material_Detail_Atp_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  Z_Rfc_Get_Material_Detail_Atp_Output () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Z_Rfc_Get_Material_Detail_Atp_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public MetaData metadataZ_Rfc_Get_Material_Detail_Atp_Output() {
        return metadata;
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Z_Rfc_Get_Material_Detail_Atp_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Z_Rfc_Get_Material_Detail_Atp_Output parent) {
            this.parent = parent;
