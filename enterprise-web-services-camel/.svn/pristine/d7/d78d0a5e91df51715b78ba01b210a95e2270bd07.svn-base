...
public class Zwrapper_Sd_Salesorder_Create_Output extends com.sap.aii.proxy.framework.core.AbstractType{

    private  static final com.sap.aii.proxy.framework.core.BaseTypeDescriptor staticDescriptor ;

    private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1354127028395L) ;

    private  Zwrapper_Sd_Salesorder_Create_Output.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "ZWRAPPER_SD_SALESORDER_CREATE.Output", 37, 0, hmh.sap.rfc.Zwrapper_Sd_Salesorder_Create_Output.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "ZWRAPPER_SD_SALESORDER_CREATE", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"en\">customer RFC wrapper for SD_SALESDOCUMENT_CREATE</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>110</ifr:sourceClient><ifr:release>620 </ifr:release><ifr:package>ZVSL</ifr:package><ifr:akhNode>HLA0009600</ifr:akhNode><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        descriptorSetElementProperties(descriptor, 0, "SALESDOCUMENT_EX", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Salesdocument_Ex", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "10"}}, "SALESDOCUMENT_EX", 0, 0, -1, 10, 20, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALESDOCUMENT_EX\"><ifr:descriptor><ifr:description language=\"en\">Number of Generated Document</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIVBELN.VBELN\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"VBELN_VA\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>10</ifr:length><ifr:internalLength1>10</ifr:internalLength1><ifr:internalLength2>20</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>10</ifr:outputLength><ifr:conversionExit>ALPHA</ifr:conversionExit></ifr:definition></ifr:scalarType></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 1, "SALES_CCARD_EX", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:ZVCC_RESPONSE", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Sales_Ccard_Ex", hmh.sap.rfc.Zvcc_ResponseType.class, new hmh.sap.rfc.Zvcc_ResponseType(), new java.lang.String[][]{}, "SALES_CCARD_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CCARD_EX\"><ifr:descriptor><ifr:description language=\"en\">Structure for Credit Card Reponse Codes</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"ZVCC_RESPONSE\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=ZVCC_RESPONSE\" /></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 2, "SALES_HEADER_OUT", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BAPISDHD", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Sales_Header_Out", hmh.sap.rfc.BapisdhdType.class, new hmh.sap.rfc.BapisdhdType(), new java.lang.String[][]{}, "SALES_HEADER_OUT", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_HEADER_OUT\"><ifr:descriptor><ifr:description language=\"en\">Bapistructure of VBAK with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDHD\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDHD\" /></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 3, "SALES_HEADER_STATUS", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BAPISDHDST", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Sales_Header_Status", hmh.sap.rfc.BapisdhdstType.class, new hmh.sap.rfc.BapisdhdstType(), new java.lang.String[][]{}, "SALES_HEADER_STATUS", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.EXPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_HEADER_STATUS\"><ifr:descriptor><ifr:description language=\"en\">Bapistructure of VBUK with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDHDST\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDHDST\" /></ifr:definition><ifr:properties><ifr:direction>out</ifr:direction><ifr:class>export</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 4, "TEXTLINES_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Textlines_Ex", hmh.sap.rfc.util.BapitextliType_List.class, new hmh.sap.rfc.BapitextliType(), new java.lang.String[][]{}, "TEXTLINES_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"TEXTLINES_EX\"><ifr:descriptor><ifr:description language=\"en\">BAPI structure for STX_LINES structure</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPITEXTLI\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPITEXTLI\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
    ...
    public hmh.sap.rfc.Bapiaddr1Type[] getPartneraddresses() {
        hmh.sap.rfc.util.Bapiaddr1Type_List i$ = (hmh.sap.rfc.util.Bapiaddr1Type_List)baseTypeData().getElementValue(29);
        if ( i$ == null){return null;}
    ...
    public void setSales_Contract_In(hmh.sap.rfc.BapictrType[] Sales_Contract_In) {
        baseTypeData().setElementValue(16, new hmh.sap.rfc.util.BapictrType_List());
    ...
    public hmh.sap.rfc.BapicondxType[] getSales_Conditions_Inx() {
        hmh.sap.rfc.util.BapicondxType_List i$ = (hmh.sap.rfc.util.BapicondxType_List)baseTypeData().getElementValue(17);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_In(hmh.sap.rfc.util.BapicondType_List Sales_Conditions_In) {
        baseTypeData().setElementValue(18, Sales_Conditions_In);
    }

    
    public hmh.sap.rfc.util.BapisdtextType_List get_as_listSales_Text() {
        return (hmh.sap.rfc.util.BapisdtextType_List)baseTypeData().getElementValue(7);
    }

    
    public hmh.sap.rfc.util.BapiparnrType_List get_as_listSales_Partners() {
        return (hmh.sap.rfc.util.BapiparnrType_List)baseTypeData().getElementValue(11);
    }

    
    public hmh.sap.rfc.util.BapiccardType_List get_as_listSales_Ccard() {
        return (hmh.sap.rfc.util.BapiccardType_List)baseTypeData().getElementValue(26);
    }

    
    public hmh.sap.rfc.util.BapicuinsType_List get_as_listSales_Cfgs_Inst() {
        return (hmh.sap.rfc.util.BapicuinsType_List)baseTypeData().getElementValue(24);
    }

    
    public void setSales_Contract_In(hmh.sap.rfc.util.BapictrType_List Sales_Contract_In) {
        baseTypeData().setElementValue(16, Sales_Contract_In);
    }

    
    public hmh.sap.rfc.BapicuvalType[] getSales_Cfgs_Value() {
        hmh.sap.rfc.util.BapicuvalType_List i$ = (hmh.sap.rfc.util.BapicuvalType_List)baseTypeData().getElementValue(20);
        if ( i$ == null){return null;}
    ...
    public void setBatch_Charc(hmh.sap.rfc.util.BapibtselType_List Batch_Charc) {
        baseTypeData().setElementValue(36, Batch_Charc);
    }

    
    public void setSales_Schedules_In(hmh.sap.rfc.util.BapischdlType_List Sales_Schedules_In) {
        baseTypeData().setElementValue(10, Sales_Schedules_In);
    }

    
    public MetaData metadataZwrapper_Sd_Salesorder_Create_Output() {
        return metadata;
    }

    
    public hmh.sap.rfc.util.Bapischdl2Type_List get_as_listSales_Sched_Conf_In() {
        return (hmh.sap.rfc.util.Bapischdl2Type_List)baseTypeData().getElementValue(8);
    }

    
    public hmh.sap.rfc.BapicurefType[] getSales_Cfgs_Refinst() {
        hmh.sap.rfc.util.BapicurefType_List i$ = (hmh.sap.rfc.util.BapicurefType_List)baseTypeData().getElementValue(21);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_In(hmh.sap.rfc.BapicondType[] Sales_Conditions_In) {
        baseTypeData().setElementValue(18, new hmh.sap.rfc.util.BapicondType_List());
    ...
    public hmh.sap.rfc.util.BapisditType_List get_as_listItems_Ex() {
        return (hmh.sap.rfc.util.BapisditType_List)baseTypeData().getElementValue(30);
    }

    
    public hmh.sap.rfc.util.BapischdlxType_List get_as_listSales_Schedules_Inx() {
        return (hmh.sap.rfc.util.BapischdlxType_List)baseTypeData().getElementValue(9);
    }

    
    public hmh.sap.rfc.util.BapiparexType_List get_as_listExtensionex() {
        return (hmh.sap.rfc.util.BapiparexType_List)baseTypeData().getElementValue(33);
    }

    
    public hmh.sap.rfc.BapisdhdType getSales_Header_Out() {
        return (hmh.sap.rfc.BapisdhdType)baseTypeData().getElementValue(2);
    }

    
    public void setSales_Items_Inx(hmh.sap.rfc.util.BapisditmxType_List Sales_Items_Inx) {
        baseTypeData().setElementValue(13, Sales_Items_Inx);
    }

    
    public hmh.sap.rfc.BapicuinsType[] getSales_Cfgs_Inst() {
        hmh.sap.rfc.util.BapicuinsType_List i$ = (hmh.sap.rfc.util.BapicuinsType_List)baseTypeData().getElementValue(24);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdbusiType_List get_as_listBusiness_Ex() {
        return (hmh.sap.rfc.util.BapisdbusiType_List)baseTypeData().getElementValue(35);
    }

    
    public hmh.sap.rfc.Bapischdl2Type[] getSales_Sched_Conf_In() {
        hmh.sap.rfc.util.Bapischdl2Type_List i$ = (hmh.sap.rfc.util.Bapischdl2Type_List)baseTypeData().getElementValue(8);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Refinst(hmh.sap.rfc.BapicurefType[] Sales_Cfgs_Refinst) {
        baseTypeData().setElementValue(21, new hmh.sap.rfc.util.BapicurefType_List());
    ...
    public hmh.sap.rfc.util.BapicondxType_List get_as_listSales_Conditions_Inx() {
        return (hmh.sap.rfc.util.BapicondxType_List)baseTypeData().getElementValue(17);
    }

    
    public hmh.sap.rfc.util.BapictrType_List get_as_listSales_Contract_In() {
        return (hmh.sap.rfc.util.BapictrType_List)baseTypeData().getElementValue(16);
    }

    
    public hmh.sap.rfc.BapicublbType[] getSales_Cfgs_Blob() {
        hmh.sap.rfc.util.BapicublbType_List i$ = (hmh.sap.rfc.util.BapicublbType_List)baseTypeData().getElementValue(25);
        if ( i$ == null){return null;}
    ...
    public void setSales_Schedules_In(hmh.sap.rfc.BapischdlType[] Sales_Schedules_In) {
        baseTypeData().setElementValue(10, new hmh.sap.rfc.util.BapischdlType_List());
    ...
    public void setSales_Partners(hmh.sap.rfc.BapiparnrType[] Sales_Partners) {
        baseTypeData().setElementValue(11, new hmh.sap.rfc.util.BapiparnrType_List());
    ...
    public hmh.sap.rfc.BapisditType[] getItems_Ex() {
        hmh.sap.rfc.util.BapisditType_List i$ = (hmh.sap.rfc.util.BapisditType_List)baseTypeData().getElementValue(30);
        if ( i$ == null){return null;}
        return  i$.toArrayBapisditType();
    }

    
    public void setSales_Ccard_Ex(hmh.sap.rfc.Zvcc_ResponseType Sales_Ccard_Ex) {
        baseTypeData().setElementValue(1, Sales_Ccard_Ex);
    }

    
    public hmh.sap.rfc.BapiincompType[] getIncomplete_Log() {
        hmh.sap.rfc.util.BapiincompType_List i$ = (hmh.sap.rfc.util.BapiincompType_List)baseTypeData().getElementValue(31);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Blob(hmh.sap.rfc.BapicublbType[] Sales_Cfgs_Blob) {
        baseTypeData().setElementValue(25, new hmh.sap.rfc.util.BapicublbType_List());
    ...
    public hmh.sap.rfc.util.BapisditmType_List get_as_listSales_Items_In() {
        return (hmh.sap.rfc.util.BapisditmType_List)baseTypeData().getElementValue(14);
    }

    
    public hmh.sap.rfc.BapisdkeyType[] getSales_Keys() {
        hmh.sap.rfc.util.BapisdkeyType_List i$ = (hmh.sap.rfc.util.BapisdkeyType_List)baseTypeData().getElementValue(12);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapiccardType[] getSales_Ccard() {
        hmh.sap.rfc.util.BapiccardType_List i$ = (hmh.sap.rfc.util.BapiccardType_List)baseTypeData().getElementValue(26);
        if ( i$ == null){return null;}
    ...
    public void setPartners_Ex(hmh.sap.rfc.BapisdpartType[] Partners_Ex) {
        baseTypeData().setElementValue(28, new hmh.sap.rfc.util.BapisdpartType_List());
    ...
    public void setSales_Conditions_Inx(hmh.sap.rfc.util.BapicondxType_List Sales_Conditions_Inx) {
        baseTypeData().setElementValue(17, Sales_Conditions_Inx);
    }

    
    public void setPartneraddresses(hmh.sap.rfc.util.Bapiaddr1Type_List Partneraddresses) {
        baseTypeData().setElementValue(29, Partneraddresses);
    }

    
    public void setSales_Items_Inx(hmh.sap.rfc.BapisditmxType[] Sales_Items_Inx) {
        baseTypeData().setElementValue(13, new hmh.sap.rfc.util.BapisditmxType_List());
    ...
    public void setSales_Items_In(hmh.sap.rfc.BapisditmType[] Sales_Items_In) {
        baseTypeData().setElementValue(14, new hmh.sap.rfc.util.BapisditmType_List());
    ...
    public void setSales_Cfgs_Inst(hmh.sap.rfc.BapicuinsType[] Sales_Cfgs_Inst) {
        baseTypeData().setElementValue(24, new hmh.sap.rfc.util.BapicuinsType_List());
    ...
    public hmh.sap.rfc.util.BapisdpartType_List get_as_listPartners_Ex() {
        return (hmh.sap.rfc.util.BapisdpartType_List)baseTypeData().getElementValue(28);
    }

    
    public hmh.sap.rfc.util.BapischdlType_List get_as_listSales_Schedules_In() {
        return (hmh.sap.rfc.util.BapischdlType_List)baseTypeData().getElementValue(10);
    }

    
    public hmh.sap.rfc.BapictrType[] getSales_Contract_In() {
        hmh.sap.rfc.util.BapictrType_List i$ = (hmh.sap.rfc.util.BapictrType_List)baseTypeData().getElementValue(16);
        if ( i$ == null){return null;}
    ...
    public void setTextheaders_Ex(hmh.sap.rfc.util.BapisdtehdType_List Textheaders_Ex) {
        baseTypeData().setElementValue(5, Textheaders_Ex);
    }

    
    public void setSales_Text(hmh.sap.rfc.BapisdtextType[] Sales_Text) {
        baseTypeData().setElementValue(7, new hmh.sap.rfc.util.BapisdtextType_List());
    ...
    public void setSales_Cfgs_Vk(hmh.sap.rfc.BapicuvkType[] Sales_Cfgs_Vk) {
        baseTypeData().setElementValue(19, new hmh.sap.rfc.util.BapicuvkType_List());
    ...
    public hmh.sap.rfc.BapiparexType[] getExtensionex() {
        hmh.sap.rfc.util.BapiparexType_List i$ = (hmh.sap.rfc.util.BapiparexType_List)baseTypeData().getElementValue(33);
        if ( i$ == null){return null;}
        return  i$.toArrayBapiparexType();
    }
    ...
    public void setExtensionex(hmh.sap.rfc.BapiparexType[] Extensionex) {
        baseTypeData().setElementValue(33, new hmh.sap.rfc.util.BapiparexType_List());
    ...
    public hmh.sap.rfc.util.BapicuvalType_List get_as_listSales_Cfgs_Value() {
        return (hmh.sap.rfc.util.BapicuvalType_List)baseTypeData().getElementValue(20);
    }

    
    public hmh.sap.rfc.util.BapitextliType_List get_as_listTextlines_Ex() {
        return (hmh.sap.rfc.util.BapitextliType_List)baseTypeData().getElementValue(4);
    }

    
    public void setSales_Cfgs_Part_Of(hmh.sap.rfc.BapicuprtType[] Sales_Cfgs_Part_Of) {
        baseTypeData().setElementValue(23, new hmh.sap.rfc.util.BapicuprtType_List());
    ...
    public hmh.sap.rfc.BapitextliType[] getTextlines_Ex() {
        hmh.sap.rfc.util.BapitextliType_List i$ = (hmh.sap.rfc.util.BapitextliType_List)baseTypeData().getElementValue(4);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapictrxType[] getSales_Contract_Inx() {
        hmh.sap.rfc.util.BapictrxType_List i$ = (hmh.sap.rfc.util.BapictrxType_List)baseTypeData().getElementValue(15);
        if ( i$ == null){return null;}
    ...
    public void setReturn(hmh.sap.rfc.Bapiret2Type[] Return) {
        baseTypeData().setElementValue(27, new hmh.sap.rfc.util.Bapiret2Type_List());
    ...
    public hmh.sap.rfc.util.BapicuvkType_List get_as_listSales_Cfgs_Vk() {
        return (hmh.sap.rfc.util.BapicuvkType_List)baseTypeData().getElementValue(19);
    }

    
    public void setExtensionex(hmh.sap.rfc.util.BapiparexType_List Extensionex) {
        baseTypeData().setElementValue(33, Extensionex);
    }

    
    public void setSchedule_Ex(hmh.sap.rfc.util.BapisdheduType_List Schedule_Ex) {
        baseTypeData().setElementValue(6, Schedule_Ex);
    }

    
    public void setSales_Contract_Inx(hmh.sap.rfc.BapictrxType[] Sales_Contract_Inx) {
        baseTypeData().setElementValue(15, new hmh.sap.rfc.util.BapictrxType_List());
    ...
    public hmh.sap.rfc.util.BapicublbType_List get_as_listSales_Cfgs_Blob() {
        return (hmh.sap.rfc.util.BapicublbType_List)baseTypeData().getElementValue(25);
    }

    
    public hmh.sap.rfc.util.BapicucfgType_List get_as_listSales_Cfgs_Ref() {
        return (hmh.sap.rfc.util.BapicucfgType_List)baseTypeData().getElementValue(22);
    }

    
    public hmh.sap.rfc.BapischdlxType[] getSales_Schedules_Inx() {
        hmh.sap.rfc.util.BapischdlxType_List i$ = (hmh.sap.rfc.util.BapischdlxType_List)baseTypeData().getElementValue(9);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Value(hmh.sap.rfc.BapicuvalType[] Sales_Cfgs_Value) {
        baseTypeData().setElementValue(20, new hmh.sap.rfc.util.BapicuvalType_List());
    ...
    public hmh.sap.rfc.BapisditmType[] getSales_Items_In() {
        hmh.sap.rfc.util.BapisditmType_List i$ = (hmh.sap.rfc.util.BapisditmType_List)baseTypeData().getElementValue(14);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.Bapiret2Type[] getReturn() {
        hmh.sap.rfc.util.Bapiret2Type_List i$ = (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(27);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Vk(hmh.sap.rfc.util.BapicuvkType_List Sales_Cfgs_Vk) {
        baseTypeData().setElementValue(19, Sales_Cfgs_Vk);
    }

    
    public hmh.sap.rfc.BapisdpartType[] getPartners_Ex() {
        hmh.sap.rfc.util.BapisdpartType_List i$ = (hmh.sap.rfc.util.BapisdpartType_List)baseTypeData().getElementValue(28);
        if ( i$ == null){return null;}
    ...
    public void setSales_Header_Status(hmh.sap.rfc.BapisdhdstType Sales_Header_Status) {
        baseTypeData().setElementValue(3, Sales_Header_Status);
    }

    
    public void setSales_Ccard(hmh.sap.rfc.BapiccardType[] Sales_Ccard) {
        baseTypeData().setElementValue(26, new hmh.sap.rfc.util.BapiccardType_List());
    ...
    public hmh.sap.rfc.BapibtselType[] getBatch_Charc() {
        hmh.sap.rfc.util.BapibtselType_List i$ = (hmh.sap.rfc.util.BapibtselType_List)baseTypeData().getElementValue(36);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_Inx(hmh.sap.rfc.BapicondxType[] Sales_Conditions_Inx) {
        baseTypeData().setElementValue(17, new hmh.sap.rfc.util.BapicondxType_List());
    ...
    public void setTextlines_Ex(hmh.sap.rfc.util.BapitextliType_List Textlines_Ex) {
        baseTypeData().setElementValue(4, Textlines_Ex);
    }

    
    public hmh.sap.rfc.util.BapictrxType_List get_as_listSales_Contract_Inx() {
        return (hmh.sap.rfc.util.BapictrxType_List)baseTypeData().getElementValue(15);
    }

    
    public hmh.sap.rfc.BapicondType[] getConditions_Ex() {
        hmh.sap.rfc.util.BapicondType_List i$ = (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(34);
        if ( i$ == null){return null;}
    ...
    public void setPartneraddresses(hmh.sap.rfc.Bapiaddr1Type[] Partneraddresses) {
        baseTypeData().setElementValue(29, new hmh.sap.rfc.util.Bapiaddr1Type_List());
    ...
    public void setSchedule_Ex(hmh.sap.rfc.BapisdheduType[] Schedule_Ex) {
        baseTypeData().setElementValue(6, new hmh.sap.rfc.util.BapisdheduType_List());
    ...
    public hmh.sap.rfc.BapicuvkType[] getSales_Cfgs_Vk() {
        hmh.sap.rfc.util.BapicuvkType_List i$ = (hmh.sap.rfc.util.BapicuvkType_List)baseTypeData().getElementValue(19);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.Bapiret2Type_List get_as_listReturn() {
        return (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(27);
    }

    
    public hmh.sap.rfc.BapisdhdstType getSales_Header_Status() {
        return (hmh.sap.rfc.BapisdhdstType)baseTypeData().getElementValue(3);
    }

    
    public void setItems_Ex(hmh.sap.rfc.util.BapisditType_List Items_Ex) {
        baseTypeData().setElementValue(30, Items_Ex);
    }

    
    public hmh.sap.rfc.BapisditmxType[] getSales_Items_Inx() {
        hmh.sap.rfc.util.BapisditmxType_List i$ = (hmh.sap.rfc.util.BapisditmxType_List)baseTypeData().getElementValue(13);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdtehdType_List get_as_listTextheaders_Ex() {
        return (hmh.sap.rfc.util.BapisdtehdType_List)baseTypeData().getElementValue(5);
    }

    
    public hmh.sap.rfc.BapiparnrType[] getSales_Partners() {
        hmh.sap.rfc.util.BapiparnrType_List i$ = (hmh.sap.rfc.util.BapiparnrType_List)baseTypeData().getElementValue(11);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapicondType[] getSales_Conditions_In() {
        hmh.sap.rfc.util.BapicondType_List i$ = (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(18);
        if ( i$ == null){return null;}
        return  i$.toArrayBapicondType();
    }
    ...
    public void setSales_Keys(hmh.sap.rfc.BapisdkeyType[] Sales_Keys) {
        baseTypeData().setElementValue(12, new hmh.sap.rfc.util.BapisdkeyType_List());
    ...
    public hmh.sap.rfc.util.BapiincompType_List get_as_listIncomplete_Log() {
        return (hmh.sap.rfc.util.BapiincompType_List)baseTypeData().getElementValue(31);
    }

    
    public hmh.sap.rfc.BapicuprtType[] getSales_Cfgs_Part_Of() {
        hmh.sap.rfc.util.BapicuprtType_List i$ = (hmh.sap.rfc.util.BapicuprtType_List)baseTypeData().getElementValue(23);
        if ( i$ == null){return null;}
    ...
    public void setBusiness_Ex(hmh.sap.rfc.util.BapisdbusiType_List Business_Ex) {
        baseTypeData().setElementValue(35, Business_Ex);
    }

    
    public void setIncomplete_Log(hmh.sap.rfc.BapiincompType[] Incomplete_Log) {
        baseTypeData().setElementValue(31, new hmh.sap.rfc.util.BapiincompType_List());
    ...
    public hmh.sap.rfc.util.BapicurefType_List get_as_listSales_Cfgs_Refinst() {
        return (hmh.sap.rfc.util.BapicurefType_List)baseTypeData().getElementValue(21);
    }

    
    public void setIncomplete_Log(hmh.sap.rfc.util.BapiincompType_List Incomplete_Log) {
        baseTypeData().setElementValue(31, Incomplete_Log);
    }

    
    public void setSales_Cfgs_Inst(hmh.sap.rfc.util.BapicuinsType_List Sales_Cfgs_Inst) {
        baseTypeData().setElementValue(24, Sales_Cfgs_Inst);
    }

    
    public void setBatch_Charc(hmh.sap.rfc.BapibtselType[] Batch_Charc) {
        baseTypeData().setElementValue(36, new hmh.sap.rfc.util.BapibtselType_List());
    ...
    public hmh.sap.rfc.BapisdbusiType[] getBusiness_Ex() {
        hmh.sap.rfc.util.BapisdbusiType_List i$ = (hmh.sap.rfc.util.BapisdbusiType_List)baseTypeData().getElementValue(35);
        if ( i$ == null){return null;}
    ...
    public void setConditions_Ex(hmh.sap.rfc.BapicondType[] Conditions_Ex) {
        baseTypeData().setElementValue(34, new hmh.sap.rfc.util.BapicondType_List());
    ...
    public hmh.sap.rfc.Zvcc_ResponseType getSales_Ccard_Ex() {
        return (hmh.sap.rfc.Zvcc_ResponseType)baseTypeData().getElementValue(1);
    }

    
    public hmh.sap.rfc.util.BapicondType_List get_as_listConditions_Ex() {
        return (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(34);
    }

    
    public void setSales_Items_In(hmh.sap.rfc.util.BapisditmType_List Sales_Items_In) {
        baseTypeData().setElementValue(14, Sales_Items_In);
    }

    
    public hmh.sap.rfc.BapisdtehdType[] getTextheaders_Ex() {
        hmh.sap.rfc.util.BapisdtehdType_List i$ = (hmh.sap.rfc.util.BapisdtehdType_List)baseTypeData().getElementValue(5);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapisdheduType[] getSchedule_Ex() {
        hmh.sap.rfc.util.BapisdheduType_List i$ = (hmh.sap.rfc.util.BapisdheduType_List)baseTypeData().getElementValue(6);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdkeyType_List get_as_listSales_Keys() {
        return (hmh.sap.rfc.util.BapisdkeyType_List)baseTypeData().getElementValue(12);
    }
    ...
    public void setSales_Cfgs_Value(hmh.sap.rfc.util.BapicuvalType_List Sales_Cfgs_Value) {
        baseTypeData().setElementValue(20, Sales_Cfgs_Value);
    }

    
    public void setSales_Ccard(hmh.sap.rfc.util.BapiccardType_List Sales_Ccard) {
        baseTypeData().setElementValue(26, Sales_Ccard);
    }

    
    public hmh.sap.rfc.BapischdlType[] getSales_Schedules_In() {
        hmh.sap.rfc.util.BapischdlType_List i$ = (hmh.sap.rfc.util.BapischdlType_List)baseTypeData().getElementValue(10);
        if ( i$ == null){return null;}
    ...
    public void setSales_Partners(hmh.sap.rfc.util.BapiparnrType_List Sales_Partners) {
        baseTypeData().setElementValue(11, Sales_Partners);
    }

    
    public void setItems_Ex(hmh.sap.rfc.BapisditType[] Items_Ex) {
        baseTypeData().setElementValue(30, new hmh.sap.rfc.util.BapisditType_List());
    ...
    public hmh.sap.rfc.util.BapisdheduType_List get_as_listSchedule_Ex() {
        return (hmh.sap.rfc.util.BapisdheduType_List)baseTypeData().getElementValue(6);
    }

    
    public hmh.sap.rfc.BapicucfgType[] getSales_Cfgs_Ref() {
        hmh.sap.rfc.util.BapicucfgType_List i$ = (hmh.sap.rfc.util.BapicucfgType_List)baseTypeData().getElementValue(22);
        if ( i$ == null){return null;}
    ...
    public void setSales_Schedules_Inx(hmh.sap.rfc.util.BapischdlxType_List Sales_Schedules_Inx) {
        baseTypeData().setElementValue(9, Sales_Schedules_Inx);
    }

    
    public void setSales_Cfgs_Ref(hmh.sap.rfc.BapicucfgType[] Sales_Cfgs_Ref) {
        baseTypeData().setElementValue(22, new hmh.sap.rfc.util.BapicucfgType_List());
    ...
    public hmh.sap.rfc.util.BapicuprtType_List get_as_listSales_Cfgs_Part_Of() {
        return (hmh.sap.rfc.util.BapicuprtType_List)baseTypeData().getElementValue(23);
    }

    
    public void setSales_Sched_Conf_In(hmh.sap.rfc.Bapischdl2Type[] Sales_Sched_Conf_In) {
        baseTypeData().setElementValue(8, new hmh.sap.rfc.util.Bapischdl2Type_List());
    ...
    public void setTextheaders_Ex(hmh.sap.rfc.BapisdtehdType[] Textheaders_Ex) {
        baseTypeData().setElementValue(5, new hmh.sap.rfc.util.BapisdtehdType_List());
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zwrapper_Sd_Salesorder_Create_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zwrapper_Sd_Salesorder_Create_Output parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getSales_Ccard_Ex() {
