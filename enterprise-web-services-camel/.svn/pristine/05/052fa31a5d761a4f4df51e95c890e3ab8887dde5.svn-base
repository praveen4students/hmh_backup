...
public class ZvparvwType extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public void setParvw(java.lang.String Parvw) {
        baseTypeData().setElementValue(0, Parvw);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  ZvparvwType parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (ZvparvwType parent) {
            this.parent = parent;
        ...
        public com.sap.aii.proxy.framework.core.JcoMetaData getParvw() {
