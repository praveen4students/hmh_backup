...
public class Zwrapper_Sd_Salesorder_Create_Input extends com.sap.aii.proxy.framework.core.AbstractType{

    private  static final com.sap.aii.proxy.framework.core.BaseTypeDescriptor staticDescriptor ;

    private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1354127028386L) ;

    private  Zwrapper_Sd_Salesorder_Create_Input.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "ZWRAPPER_SD_SALESORDER_CREATE.Input", 46, 0, hmh.sap.rfc.Zwrapper_Sd_Salesorder_Create_Input.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "ZWRAPPER_SD_SALESORDER_CREATE", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"en\">customer RFC wrapper for SD_SALESDOCUMENT_CREATE</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>110</ifr:sourceClient><ifr:release>620 </ifr:release><ifr:package>ZVSL</ifr:package><ifr:akhNode>HLA0009600</ifr:akhNode><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        descriptorSetElementProperties(descriptor, 0, "BEHAVE_WHEN_ERROR", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Behave_When_Error", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "BEHAVE_WHEN_ERROR", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"BEHAVE_WHEN_ERROR\"><ifr:descriptor><ifr:description language=\"en\">Error Handling</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIFLAG.BAPIFLAG\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>SPACE</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 1, "BINARY_RELATIONSHIPTYPE", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Binary_Relationshiptype", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "4"}}, "BINARY_RELATIONSHIPTYPE", 0, 0, -1, 4, 8, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"BINARY_RELATIONSHIPTYPE\"><ifr:descriptor><ifr:description language=\"en\">Binary Relationship Type (Private)</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BRELTYP.RELTYPE\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"BINRELTYP\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>4</ifr:length><ifr:internalLength1>4</ifr:internalLength1><ifr:internalLength2>8</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>4</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>SPACE</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 2, "BUSINESS_OBJECT", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Business_Object", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "10"}}, "BUSINESS_OBJECT", 0, 0, -1, 10, 20, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"BUSINESS_OBJECT\"><ifr:descriptor><ifr:description language=\"en\">Business-Objekt</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIUSW01.OBJTYPE\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>3</ifr:offset1><ifr:offset2>6</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"OJ_NAME\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>10</ifr:length><ifr:internalLength1>10</ifr:internalLength1><ifr:internalLength2>20</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>10</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>SPACE</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 3, "CONVERT_PARVW_AUART", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Convert_Parvw_Auart", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "CONVERT_PARVW_AUART", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"CONVERT_PARVW_AUART\"><ifr:descriptor><ifr:description language=\"en\">Conversion of Partner Function + Order Type</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIFLAG.BAPIFLAG\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>SPACE</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 4, "INT_NUMBER_ASSIGNMENT", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Int_Number_Assignment", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "INT_NUMBER_ASSIGNMENT", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"INT_NUMBER_ASSIGNMENT\"><ifr:descriptor><ifr:description language=\"en\">Internal Item Number Assignment</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIFLAG.BAPIFLAG\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>SPACE</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 5, "LOGIC_SWITCH", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BAPISDLS", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Logic_Switch", hmh.sap.rfc.BapisdlsType.class, new hmh.sap.rfc.BapisdlsType(), new java.lang.String[][]{}, "LOGIC_SWITCH", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"LOGIC_SWITCH\"><ifr:descriptor><ifr:description language=\"en\">Internal Control Parameter</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDLS\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDLS\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 6, "REACT", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "React", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "REACT", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"REACT\"><ifr:descriptor><ifr:description language=\"en\">Used for Special Conditions</ifr:description></ifr:descriptor><ifr:definition><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 7, "SALESDOCUMENT", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Salesdocument", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "10"}}, "SALESDOCUMENT", 0, 0, -1, 10, 20, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALESDOCUMENT\"><ifr:descriptor><ifr:description language=\"en\">Sales and Distribution Document Number</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIVBELN.VBELN\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"VBELN_VA\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>10</ifr:length><ifr:internalLength1>10</ifr:internalLength1><ifr:internalLength2>20</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>10</ifr:outputLength><ifr:conversionExit>ALPHA</ifr:conversionExit></ifr:definition></ifr:scalarType></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 8, "SALES_HEADER_IN", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BAPISDHD1", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Sales_Header_In", hmh.sap.rfc.Bapisdhd1Type.class, new hmh.sap.rfc.Bapisdhd1Type(), new java.lang.String[][]{}, "SALES_HEADER_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_HEADER_IN\"><ifr:descriptor><ifr:description language=\"en\">Order Header</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDHD1\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDHD1\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>false</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 9, "SALES_HEADER_INX", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BAPISDHD1X", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Sales_Header_Inx", hmh.sap.rfc.Bapisdhd1XType.class, new hmh.sap.rfc.Bapisdhd1XType(), new java.lang.String[][]{}, "SALES_HEADER_INX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_HEADER_INX\"><ifr:descriptor><ifr:description language=\"en\">Sales Order Check List</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDHD1X\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDHD1X\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 10, "SENDER", null, null, "unqualified", "urn:sap-com:document:sap:rfc:functions:BDI_LOGSYS", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Sender", hmh.sap.rfc.Bdi_LogsysType.class, new hmh.sap.rfc.Bdi_LogsysType(), new java.lang.String[][]{}, "SENDER", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_STRUCTURE, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SENDER\"><ifr:descriptor><ifr:description language=\"en\">Logical System - Sender</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BDI_LOGSYS\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BDI_LOGSYS\" /></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 11, "STATUS_BUFFER_REFRESH", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Status_Buffer_Refresh", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "STATUS_BUFFER_REFRESH", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"STATUS_BUFFER_REFRESH\"><ifr:descriptor><ifr:description language=\"en\">Status Buffer Refresh</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIFLAG.BAPIFLAG\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType><ifr:defaultDefinition>&apos;X&apos;</ifr:defaultDefinition></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 12, "TESTRUN", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 0, 1, false, null, "Testrun", java.lang.String.class, null, new java.lang.String[][]{{"maxLength", "1"}}, "TESTRUN", 0, 0, -1, 1, 2, -1, com.sap.mw.jco.JCO.TYPE_CHAR, com.sap.mw.jco.JCO.IMPORT_PARAMETER, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"TESTRUN\"><ifr:descriptor><ifr:description language=\"en\">Test Run</ifr:description></ifr:descriptor><ifr:definition><ifr:field name=\"BAPIFLAG.BAPIFLAG\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:offset1>0</ifr:offset1><ifr:offset2>0</ifr:offset2></ifr:properties></ifr:field><ifr:scalarType name=\"CHAR1\"><ifr:properties><ifr:helpValuesSupported>false</ifr:helpValuesSupported><ifr:fixedValuesListDefined>false</ifr:fixedValuesListDefined><ifr:mixedCaseSupported>false</ifr:mixedCaseSupported><ifr:signedNumber>false</ifr:signedNumber></ifr:properties><ifr:definition><ifr:type>CHAR</ifr:type><ifr:abapType>C</ifr:abapType><ifr:length>1</ifr:length><ifr:internalLength1>1</ifr:internalLength1><ifr:internalLength2>2</ifr:internalLength2><ifr:decimals>0</ifr:decimals><ifr:outputLength>1</ifr:outputLength></ifr:definition></ifr:scalarType></ifr:definition><ifr:properties><ifr:direction>in</ifr:direction><ifr:class>import</ifr:class><ifr:type>scalar</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 13, "TEXTLINES_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Textlines_Ex", hmh.sap.rfc.util.BapitextliType_List.class, new hmh.sap.rfc.BapitextliType(), new java.lang.String[][]{}, "TEXTLINES_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"TEXTLINES_EX\"><ifr:descriptor><ifr:description language=\"en\">BAPI structure for STX_LINES structure</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPITEXTLI\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPITEXTLI\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 14, "TEXTHEADERS_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Textheaders_Ex", hmh.sap.rfc.util.BapisdtehdType_List.class, new hmh.sap.rfc.BapisdtehdType(), new java.lang.String[][]{}, "TEXTHEADERS_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"TEXTHEADERS_EX\"><ifr:descriptor><ifr:description language=\"en\">Bapistructure of THEAD with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDTEHD\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDTEHD\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 15, "SCHEDULE_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Schedule_Ex", hmh.sap.rfc.util.BapisdheduType_List.class, new hmh.sap.rfc.BapisdheduType(), new java.lang.String[][]{}, "SCHEDULE_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SCHEDULE_EX\"><ifr:descriptor><ifr:description language=\"en\">Struture of VBEP with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDHEDU\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDHEDU\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 16, "SALES_TEXT", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Text", hmh.sap.rfc.util.BapisdtextType_List.class, new hmh.sap.rfc.BapisdtextType(), new java.lang.String[][]{}, "SALES_TEXT", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_TEXT\"><ifr:descriptor><ifr:description language=\"en\">Texte</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDTEXT\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDTEXT\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 17, "SALES_SCHED_CONF_IN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Sched_Conf_In", hmh.sap.rfc.util.Bapischdl2Type_List.class, new hmh.sap.rfc.Bapischdl2Type(), new java.lang.String[][]{}, "SALES_SCHED_CONF_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_SCHED_CONF_IN\"><ifr:descriptor><ifr:description language=\"en\">Einteilungsdaten Bestätigung</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISCHDL2\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISCHDL2\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 18, "SALES_SCHEDULES_INX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Schedules_Inx", hmh.sap.rfc.util.BapischdlxType_List.class, new hmh.sap.rfc.BapischdlxType(), new java.lang.String[][]{}, "SALES_SCHEDULES_INX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_SCHEDULES_INX\"><ifr:descriptor><ifr:description language=\"en\">Ankreuzleiste Einteilungsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISCHDLX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISCHDLX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 19, "SALES_SCHEDULES_IN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Schedules_In", hmh.sap.rfc.util.BapischdlType_List.class, new hmh.sap.rfc.BapischdlType(), new java.lang.String[][]{}, "SALES_SCHEDULES_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_SCHEDULES_IN\"><ifr:descriptor><ifr:description language=\"en\">Einteilungsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISCHDL\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISCHDL\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 20, "SALES_PARTNERS", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Partners", hmh.sap.rfc.util.BapiparnrType_List.class, new hmh.sap.rfc.BapiparnrType(), new java.lang.String[][]{}, "SALES_PARTNERS", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_PARTNERS\"><ifr:descriptor><ifr:description language=\"en\">Belegpartner</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIPARNR\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIPARNR\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 21, "SALES_KEYS", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Keys", hmh.sap.rfc.util.BapisdkeyType_List.class, new hmh.sap.rfc.BapisdkeyType(), new java.lang.String[][]{}, "SALES_KEYS", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_KEYS\"><ifr:descriptor><ifr:description language=\"en\">Ausgabetabelle der Referenzschlüssel</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDKEY\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDKEY\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 22, "SALES_ITEMS_INX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Items_Inx", hmh.sap.rfc.util.BapisditmxType_List.class, new hmh.sap.rfc.BapisditmxType(), new java.lang.String[][]{}, "SALES_ITEMS_INX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_ITEMS_INX\"><ifr:descriptor><ifr:description language=\"en\">Ankreuzleiste Positionsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDITMX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDITMX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 23, "SALES_ITEMS_IN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Items_In", hmh.sap.rfc.util.BapisditmType_List.class, new hmh.sap.rfc.BapisditmType(), new java.lang.String[][]{}, "SALES_ITEMS_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_ITEMS_IN\"><ifr:descriptor><ifr:description language=\"en\">Positionsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDITM\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDITM\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 24, "SALES_CONTRACT_INX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Contract_Inx", hmh.sap.rfc.util.BapictrxType_List.class, new hmh.sap.rfc.BapictrxType(), new java.lang.String[][]{}, "SALES_CONTRACT_INX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CONTRACT_INX\"><ifr:descriptor><ifr:description language=\"en\">Ankreuzleiste: Vertagsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICTRX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICTRX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 25, "SALES_CONTRACT_IN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Contract_In", hmh.sap.rfc.util.BapictrType_List.class, new hmh.sap.rfc.BapictrType(), new java.lang.String[][]{}, "SALES_CONTRACT_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CONTRACT_IN\"><ifr:descriptor><ifr:description language=\"en\">Vertagsdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICTR\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICTR\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 26, "SALES_CONDITIONS_INX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Conditions_Inx", hmh.sap.rfc.util.BapicondxType_List.class, new hmh.sap.rfc.BapicondxType(), new java.lang.String[][]{}, "SALES_CONDITIONS_INX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CONDITIONS_INX\"><ifr:descriptor><ifr:description language=\"en\">Ankreuzleiste Konditionen</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICONDX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICONDX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 27, "SALES_CONDITIONS_IN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Conditions_In", hmh.sap.rfc.util.BapicondType_List.class, new hmh.sap.rfc.BapicondType(), new java.lang.String[][]{}, "SALES_CONDITIONS_IN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CONDITIONS_IN\"><ifr:descriptor><ifr:description language=\"en\">Konditionen</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICOND\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICOND\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 28, "SALES_CFGS_VK", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Vk", hmh.sap.rfc.util.BapicuvkType_List.class, new hmh.sap.rfc.BapicuvkType(), new java.lang.String[][]{}, "SALES_CFGS_VK", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_VK\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Variantenkonditionsschluessel</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUVK\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUVK\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 29, "SALES_CFGS_VALUE", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Value", hmh.sap.rfc.util.BapicuvalType_List.class, new hmh.sap.rfc.BapicuvalType(), new java.lang.String[][]{}, "SALES_CFGS_VALUE", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_VALUE\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Merkmalswerte</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUVAL\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUVAL\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 30, "SALES_CFGS_REFINST", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Refinst", hmh.sap.rfc.util.BapicurefType_List.class, new hmh.sap.rfc.BapicurefType(), new java.lang.String[][]{}, "SALES_CFGS_REFINST", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_REFINST\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Referenz Position / Instanz</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUREF\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUREF\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 31, "SALES_CFGS_REF", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Ref", hmh.sap.rfc.util.BapicucfgType_List.class, new hmh.sap.rfc.BapicucfgType(), new java.lang.String[][]{}, "SALES_CFGS_REF", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_REF\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Referenzdaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUCFG\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUCFG\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 32, "SALES_CFGS_PART_OF", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Part_Of", hmh.sap.rfc.util.BapicuprtType_List.class, new hmh.sap.rfc.BapicuprtType(), new java.lang.String[][]{}, "SALES_CFGS_PART_OF", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_PART_OF\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Part-of Angaben</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUPRT\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUPRT\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 33, "SALES_CFGS_INST", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Inst", hmh.sap.rfc.util.BapicuinsType_List.class, new hmh.sap.rfc.BapicuinsType(), new java.lang.String[][]{}, "SALES_CFGS_INST", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_INST\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: Instanzen</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUINS\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUINS\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 34, "SALES_CFGS_BLOB", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Cfgs_Blob", hmh.sap.rfc.util.BapicublbType_List.class, new hmh.sap.rfc.BapicublbType(), new java.lang.String[][]{}, "SALES_CFGS_BLOB", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CFGS_BLOB\"><ifr:descriptor><ifr:description language=\"en\">Konfiguration: BLOB interne Daten (SCE)</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICUBLB\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICUBLB\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 35, "SALES_CCARD", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Sales_Ccard", hmh.sap.rfc.util.BapiccardType_List.class, new hmh.sap.rfc.BapiccardType(), new java.lang.String[][]{}, "SALES_CCARD", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"SALES_CCARD\"><ifr:descriptor><ifr:description language=\"en\">Kreditkartendaten</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICCARD\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICCARD\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 36, "RETURN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Return", hmh.sap.rfc.util.Bapiret2Type_List.class, new hmh.sap.rfc.Bapiret2Type(), new java.lang.String[][]{}, "RETURN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"RETURN\"><ifr:descriptor><ifr:description language=\"en\">Rückgabemeldungen</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIRET2\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIRET2\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 37, "PARTNERS_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Partners_Ex", hmh.sap.rfc.util.BapisdpartType_List.class, new hmh.sap.rfc.BapisdpartType(), new java.lang.String[][]{}, "PARTNERS_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"PARTNERS_EX\"><ifr:descriptor><ifr:description language=\"en\">Bapistructure of VBPA with english fieldnames</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDPART\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDPART\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 38, "PARTNERADDRESSES", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Partneraddresses", hmh.sap.rfc.util.Bapiaddr1Type_List.class, new hmh.sap.rfc.Bapiaddr1Type(), new java.lang.String[][]{}, "PARTNERADDRESSES", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"PARTNERADDRESSES\"><ifr:descriptor><ifr:description language=\"en\">BAPI-Referenzstruktur für Adressen (Org./Firma)</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIADDR1\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIADDR1\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 39, "ITEMS_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Items_Ex", hmh.sap.rfc.util.BapisditType_List.class, new hmh.sap.rfc.BapisditType(), new java.lang.String[][]{}, "ITEMS_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"ITEMS_EX\"><ifr:descriptor><ifr:description language=\"en\">Structure of VBAP with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDIT\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDIT\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 40, "INCOMPLETE_LOG", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Incomplete_Log", hmh.sap.rfc.util.BapiincompType_List.class, new hmh.sap.rfc.BapiincompType(), new java.lang.String[][]{}, "INCOMPLETE_LOG", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"INCOMPLETE_LOG\"><ifr:descriptor><ifr:description language=\"en\">Kommunikationsfelder: Unvollständigkeit</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIINCOMP\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIINCOMP\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 41, "EXTENSIONIN", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Extensionin", hmh.sap.rfc.util.BapiparexType_List.class, new hmh.sap.rfc.BapiparexType(), new java.lang.String[][]{}, "EXTENSIONIN", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"EXTENSIONIN\"><ifr:descriptor><ifr:description language=\"en\">Kundenerweiterung Import</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIPAREX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIPAREX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 42, "EXTENSIONEX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Extensionex", hmh.sap.rfc.util.BapiparexType_List.class, new hmh.sap.rfc.BapiparexType(), new java.lang.String[][]{}, "EXTENSIONEX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"EXTENSIONEX\"><ifr:descriptor><ifr:description language=\"en\">Bezugsstruktur für BAPI-Parameter ExtensionIn / ExtensionOut</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIPAREX\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIPAREX\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 43, "CONDITIONS_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Conditions_Ex", hmh.sap.rfc.util.BapicondType_List.class, new hmh.sap.rfc.BapicondType(), new java.lang.String[][]{}, "CONDITIONS_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"CONDITIONS_EX\"><ifr:descriptor><ifr:description language=\"en\">Kommunikationsfelder zur Pflege der Konditionen im Auftrag</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPICOND\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPICOND\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 44, "BUSINESS_EX", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Business_Ex", hmh.sap.rfc.util.BapisdbusiType_List.class, new hmh.sap.rfc.BapisdbusiType(), new java.lang.String[][]{}, "BUSINESS_EX", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"BUSINESS_EX\"><ifr:descriptor><ifr:description language=\"en\">Bapistructure of VBKD with english field names</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPISDBUSI\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPISDBUSI\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        descriptorSetElementProperties(descriptor, 45, "BATCH_CHARC", null, null, "unqualified", null, "urn:sap-com:document:sap:rfc:functions", false, 0, -1, false, null, "Batch_Charc", hmh.sap.rfc.util.BapibtselType_List.class, new hmh.sap.rfc.BapibtselType(), new java.lang.String[][]{}, "BATCH_CHARC", 0, 0, -1, -1, -1, -1, com.sap.mw.jco.JCO.TYPE_TABLE, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:parameter name=\"BATCH_CHARC\"><ifr:descriptor><ifr:description language=\"en\">BAPI Übergabestruktur Selektionsdaten CRM -&gt; R/3</ifr:description></ifr:descriptor><ifr:definition><ifr:complexType name=\"BAPIBTSEL\" type=\"structure\" xlink:role=\"type\" xlink:href=\"/Content?TYPE=type&amp;NAME=BAPIBTSEL\" /></ifr:definition><ifr:properties><ifr:direction>inout</ifr:direction><ifr:class>tables</ifr:class><ifr:type>structure</ifr:type><ifr:optional>true</ifr:optional><ifr:basedOnDictionaryReference>true</ifr:basedOnDictionaryReference></ifr:properties></ifr:parameter>");
        staticDescriptor = descriptor;
    }
    public  Zwrapper_Sd_Salesorder_Create_Input () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  Zwrapper_Sd_Salesorder_Create_Input (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    
    public void setSales_Cfgs_Blob(hmh.sap.rfc.util.BapicublbType_List Sales_Cfgs_Blob) {
        baseTypeData().setElementValue(34, Sales_Cfgs_Blob);
    }

    
    public hmh.sap.rfc.util.BapisditmxType_List get_as_listSales_Items_Inx() {
        return (hmh.sap.rfc.util.BapisditmxType_List)baseTypeData().getElementValue(22);
    }

    
    public hmh.sap.rfc.util.BapicondType_List get_as_listSales_Conditions_In() {
        return (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(27);
    }

    
    public hmh.sap.rfc.BapisdtextType[] getSales_Text() {
        hmh.sap.rfc.util.BapisdtextType_List i$ = (hmh.sap.rfc.util.BapisdtextType_List)baseTypeData().getElementValue(16);
    ...
    public hmh.sap.rfc.Bapiaddr1Type[] getPartneraddresses() {
        hmh.sap.rfc.util.Bapiaddr1Type_List i$ = (hmh.sap.rfc.util.Bapiaddr1Type_List)baseTypeData().getElementValue(38);
        if ( i$ == null){return null;}
    ...
    public void setSales_Contract_In(hmh.sap.rfc.BapictrType[] Sales_Contract_In) {
        baseTypeData().setElementValue(25, new hmh.sap.rfc.util.BapictrType_List());
    ...
    public hmh.sap.rfc.Bdi_LogsysType getSender() {
        return (hmh.sap.rfc.Bdi_LogsysType)baseTypeData().getElementValue(10);
    }
    ...
    public hmh.sap.rfc.BapicondxType[] getSales_Conditions_Inx() {
        hmh.sap.rfc.util.BapicondxType_List i$ = (hmh.sap.rfc.util.BapicondxType_List)baseTypeData().getElementValue(26);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_In(hmh.sap.rfc.util.BapicondType_List Sales_Conditions_In) {
        baseTypeData().setElementValue(27, Sales_Conditions_In);
    }

    
    public hmh.sap.rfc.util.BapisdtextType_List get_as_listSales_Text() {
        return (hmh.sap.rfc.util.BapisdtextType_List)baseTypeData().getElementValue(16);
    }

    
    public hmh.sap.rfc.util.BapiccardType_List get_as_listSales_Ccard() {
        return (hmh.sap.rfc.util.BapiccardType_List)baseTypeData().getElementValue(35);
    }
    ...
    public hmh.sap.rfc.util.BapiparnrType_List get_as_listSales_Partners() {
        return (hmh.sap.rfc.util.BapiparnrType_List)baseTypeData().getElementValue(20);
    }

    
    public hmh.sap.rfc.util.BapicuinsType_List get_as_listSales_Cfgs_Inst() {
        return (hmh.sap.rfc.util.BapicuinsType_List)baseTypeData().getElementValue(33);
    }
    ...
    public void setSales_Contract_In(hmh.sap.rfc.util.BapictrType_List Sales_Contract_In) {
        baseTypeData().setElementValue(25, Sales_Contract_In);
    }

    
    public hmh.sap.rfc.BapicuvalType[] getSales_Cfgs_Value() {
        hmh.sap.rfc.util.BapicuvalType_List i$ = (hmh.sap.rfc.util.BapicuvalType_List)baseTypeData().getElementValue(29);
        if ( i$ == null){return null;}
    ...
    public void setBatch_Charc(hmh.sap.rfc.util.BapibtselType_List Batch_Charc) {
        baseTypeData().setElementValue(45, Batch_Charc);
    }
    ...
    public void setSales_Schedules_In(hmh.sap.rfc.util.BapischdlType_List Sales_Schedules_In) {
        baseTypeData().setElementValue(19, Sales_Schedules_In);
    }

    
    public hmh.sap.rfc.util.Bapischdl2Type_List get_as_listSales_Sched_Conf_In() {
        return (hmh.sap.rfc.util.Bapischdl2Type_List)baseTypeData().getElementValue(17);
    }
    ...
    public hmh.sap.rfc.BapicurefType[] getSales_Cfgs_Refinst() {
        hmh.sap.rfc.util.BapicurefType_List i$ = (hmh.sap.rfc.util.BapicurefType_List)baseTypeData().getElementValue(30);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_In(hmh.sap.rfc.BapicondType[] Sales_Conditions_In) {
        baseTypeData().setElementValue(27, new hmh.sap.rfc.util.BapicondType_List());
    ...
    public void setSales_Header_In(hmh.sap.rfc.Bapisdhd1Type Sales_Header_In) {
        baseTypeData().setElementValue(8, Sales_Header_In);
    }

    
    public hmh.sap.rfc.util.BapisditType_List get_as_listItems_Ex() {
        return (hmh.sap.rfc.util.BapisditType_List)baseTypeData().getElementValue(39);
    }

    
    public hmh.sap.rfc.util.BapischdlxType_List get_as_listSales_Schedules_Inx() {
        return (hmh.sap.rfc.util.BapischdlxType_List)baseTypeData().getElementValue(18);
    }

    
    public hmh.sap.rfc.util.BapiparexType_List get_as_listExtensionex() {
        return (hmh.sap.rfc.util.BapiparexType_List)baseTypeData().getElementValue(42);
    }

    
    public MetaData metadataZwrapper_Sd_Salesorder_Create_Input() {
        return metadata;
    }

    
    public void setSales_Items_Inx(hmh.sap.rfc.util.BapisditmxType_List Sales_Items_Inx) {
        baseTypeData().setElementValue(22, Sales_Items_Inx);
    }

    
    public hmh.sap.rfc.BapicuinsType[] getSales_Cfgs_Inst() {
        hmh.sap.rfc.util.BapicuinsType_List i$ = (hmh.sap.rfc.util.BapicuinsType_List)baseTypeData().getElementValue(33);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdbusiType_List get_as_listBusiness_Ex() {
        return (hmh.sap.rfc.util.BapisdbusiType_List)baseTypeData().getElementValue(44);
    }

    
    public void setSender(hmh.sap.rfc.Bdi_LogsysType Sender) {
        baseTypeData().setElementValue(10, Sender);
    }

    
    public void setSales_Cfgs_Refinst(hmh.sap.rfc.BapicurefType[] Sales_Cfgs_Refinst) {
        baseTypeData().setElementValue(30, new hmh.sap.rfc.util.BapicurefType_List());
    ...
    public hmh.sap.rfc.Bapischdl2Type[] getSales_Sched_Conf_In() {
        hmh.sap.rfc.util.Bapischdl2Type_List i$ = (hmh.sap.rfc.util.Bapischdl2Type_List)baseTypeData().getElementValue(17);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapicondxType_List get_as_listSales_Conditions_Inx() {
        return (hmh.sap.rfc.util.BapicondxType_List)baseTypeData().getElementValue(26);
    }

    
    public hmh.sap.rfc.util.BapictrType_List get_as_listSales_Contract_In() {
        return (hmh.sap.rfc.util.BapictrType_List)baseTypeData().getElementValue(25);
    }

    
    public hmh.sap.rfc.BapicublbType[] getSales_Cfgs_Blob() {
        hmh.sap.rfc.util.BapicublbType_List i$ = (hmh.sap.rfc.util.BapicublbType_List)baseTypeData().getElementValue(34);
        if ( i$ == null){return null;}
    ...
    public void setSales_Schedules_In(hmh.sap.rfc.BapischdlType[] Sales_Schedules_In) {
        baseTypeData().setElementValue(19, new hmh.sap.rfc.util.BapischdlType_List());
    ...
    public void setSales_Partners(hmh.sap.rfc.BapiparnrType[] Sales_Partners) {
        baseTypeData().setElementValue(20, new hmh.sap.rfc.util.BapiparnrType_List());
    ...
    public hmh.sap.rfc.BapisditType[] getItems_Ex() {
        hmh.sap.rfc.util.BapisditType_List i$ = (hmh.sap.rfc.util.BapisditType_List)baseTypeData().getElementValue(39);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapiincompType[] getIncomplete_Log() {
        hmh.sap.rfc.util.BapiincompType_List i$ = (hmh.sap.rfc.util.BapiincompType_List)baseTypeData().getElementValue(40);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Blob(hmh.sap.rfc.BapicublbType[] Sales_Cfgs_Blob) {
        baseTypeData().setElementValue(34, new hmh.sap.rfc.util.BapicublbType_List());
    ...
    public hmh.sap.rfc.util.BapisditmType_List get_as_listSales_Items_In() {
        return (hmh.sap.rfc.util.BapisditmType_List)baseTypeData().getElementValue(23);
    }

    
    public hmh.sap.rfc.BapisdkeyType[] getSales_Keys() {
        hmh.sap.rfc.util.BapisdkeyType_List i$ = (hmh.sap.rfc.util.BapisdkeyType_List)baseTypeData().getElementValue(21);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapiccardType[] getSales_Ccard() {
        hmh.sap.rfc.util.BapiccardType_List i$ = (hmh.sap.rfc.util.BapiccardType_List)baseTypeData().getElementValue(35);
        if ( i$ == null){return null;}
    ...
    public void setPartners_Ex(hmh.sap.rfc.BapisdpartType[] Partners_Ex) {
        baseTypeData().setElementValue(37, new hmh.sap.rfc.util.BapisdpartType_List());
    ...
    public void setSales_Items_In(hmh.sap.rfc.BapisditmType[] Sales_Items_In) {
        baseTypeData().setElementValue(23, new hmh.sap.rfc.util.BapisditmType_List());
    ...
    public void setSales_Cfgs_Inst(hmh.sap.rfc.BapicuinsType[] Sales_Cfgs_Inst) {
        baseTypeData().setElementValue(33, new hmh.sap.rfc.util.BapicuinsType_List());
    ...
    public hmh.sap.rfc.util.BapisdpartType_List get_as_listPartners_Ex() {
        return (hmh.sap.rfc.util.BapisdpartType_List)baseTypeData().getElementValue(37);
    }

    
    public hmh.sap.rfc.util.BapischdlType_List get_as_listSales_Schedules_In() {
        return (hmh.sap.rfc.util.BapischdlType_List)baseTypeData().getElementValue(19);
    }

    
    public hmh.sap.rfc.BapictrType[] getSales_Contract_In() {
        hmh.sap.rfc.util.BapictrType_List i$ = (hmh.sap.rfc.util.BapictrType_List)baseTypeData().getElementValue(25);
        if ( i$ == null){return null;}
    ...
    public void setTextheaders_Ex(hmh.sap.rfc.util.BapisdtehdType_List Textheaders_Ex) {
        baseTypeData().setElementValue(14, Textheaders_Ex);
    }

    
    public void setSales_Text(hmh.sap.rfc.BapisdtextType[] Sales_Text) {
        baseTypeData().setElementValue(16, new hmh.sap.rfc.util.BapisdtextType_List());
    ...
    public void setSales_Cfgs_Vk(hmh.sap.rfc.BapicuvkType[] Sales_Cfgs_Vk) {
        baseTypeData().setElementValue(28, new hmh.sap.rfc.util.BapicuvkType_List());
    ...
    public hmh.sap.rfc.BapiparexType[] getExtensionex() {
        hmh.sap.rfc.util.BapiparexType_List i$ = (hmh.sap.rfc.util.BapiparexType_List)baseTypeData().getElementValue(42);
        if ( i$ == null){return null;}
        return  i$.toArrayBapiparexType();
    }
    ...
    public void setExtensionex(hmh.sap.rfc.BapiparexType[] Extensionex) {
        baseTypeData().setElementValue(42, new hmh.sap.rfc.util.BapiparexType_List());
    ...
    public hmh.sap.rfc.util.BapicuvalType_List get_as_listSales_Cfgs_Value() {
        return (hmh.sap.rfc.util.BapicuvalType_List)baseTypeData().getElementValue(29);
    }

    
    public hmh.sap.rfc.util.BapitextliType_List get_as_listTextlines_Ex() {
        return (hmh.sap.rfc.util.BapitextliType_List)baseTypeData().getElementValue(13);
    }

    
    public void setSales_Cfgs_Part_Of(hmh.sap.rfc.BapicuprtType[] Sales_Cfgs_Part_Of) {
        baseTypeData().setElementValue(32, new hmh.sap.rfc.util.BapicuprtType_List());
    ...
    public hmh.sap.rfc.BapitextliType[] getTextlines_Ex() {
        hmh.sap.rfc.util.BapitextliType_List i$ = (hmh.sap.rfc.util.BapitextliType_List)baseTypeData().getElementValue(13);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapictrxType[] getSales_Contract_Inx() {
        hmh.sap.rfc.util.BapictrxType_List i$ = (hmh.sap.rfc.util.BapictrxType_List)baseTypeData().getElementValue(24);
        if ( i$ == null){return null;}
    ...
    public void setReturn(hmh.sap.rfc.Bapiret2Type[] Return) {
        baseTypeData().setElementValue(36, new hmh.sap.rfc.util.Bapiret2Type_List());
    ...
    public hmh.sap.rfc.Bapisdhd1XType getSales_Header_Inx() {
        return (hmh.sap.rfc.Bapisdhd1XType)baseTypeData().getElementValue(9);
    }

    
    public hmh.sap.rfc.util.BapicuvkType_List get_as_listSales_Cfgs_Vk() {
        return (hmh.sap.rfc.util.BapicuvkType_List)baseTypeData().getElementValue(28);
    }

    
    public void setExtensionex(hmh.sap.rfc.util.BapiparexType_List Extensionex) {
        baseTypeData().setElementValue(42, Extensionex);
    }

    
    public void setSchedule_Ex(hmh.sap.rfc.util.BapisdheduType_List Schedule_Ex) {
        baseTypeData().setElementValue(15, Schedule_Ex);
    }

    
    public void setSales_Contract_Inx(hmh.sap.rfc.BapictrxType[] Sales_Contract_Inx) {
        baseTypeData().setElementValue(24, new hmh.sap.rfc.util.BapictrxType_List());
    ...
    public hmh.sap.rfc.util.BapicublbType_List get_as_listSales_Cfgs_Blob() {
        return (hmh.sap.rfc.util.BapicublbType_List)baseTypeData().getElementValue(34);
    }

    
    public hmh.sap.rfc.util.BapicucfgType_List get_as_listSales_Cfgs_Ref() {
        return (hmh.sap.rfc.util.BapicucfgType_List)baseTypeData().getElementValue(31);
    }

    
    public hmh.sap.rfc.BapischdlxType[] getSales_Schedules_Inx() {
        hmh.sap.rfc.util.BapischdlxType_List i$ = (hmh.sap.rfc.util.BapischdlxType_List)baseTypeData().getElementValue(18);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Value(hmh.sap.rfc.BapicuvalType[] Sales_Cfgs_Value) {
        baseTypeData().setElementValue(29, new hmh.sap.rfc.util.BapicuvalType_List());
    ...
    public hmh.sap.rfc.BapisditmType[] getSales_Items_In() {
        hmh.sap.rfc.util.BapisditmType_List i$ = (hmh.sap.rfc.util.BapisditmType_List)baseTypeData().getElementValue(23);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.Bapiret2Type[] getReturn() {
        hmh.sap.rfc.util.Bapiret2Type_List i$ = (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(36);
        if ( i$ == null){return null;}
    ...
    public void setSales_Cfgs_Vk(hmh.sap.rfc.util.BapicuvkType_List Sales_Cfgs_Vk) {
        baseTypeData().setElementValue(28, Sales_Cfgs_Vk);
    }

    
    public hmh.sap.rfc.BapisdpartType[] getPartners_Ex() {
        hmh.sap.rfc.util.BapisdpartType_List i$ = (hmh.sap.rfc.util.BapisdpartType_List)baseTypeData().getElementValue(37);
        if ( i$ == null){return null;}
    ...
    public void setSales_Ccard(hmh.sap.rfc.BapiccardType[] Sales_Ccard) {
        baseTypeData().setElementValue(35, new hmh.sap.rfc.util.BapiccardType_List());
    ...
    public hmh.sap.rfc.BapibtselType[] getBatch_Charc() {
        hmh.sap.rfc.util.BapibtselType_List i$ = (hmh.sap.rfc.util.BapibtselType_List)baseTypeData().getElementValue(45);
        if ( i$ == null){return null;}
    ...
    public void setSales_Conditions_Inx(hmh.sap.rfc.BapicondxType[] Sales_Conditions_Inx) {
        baseTypeData().setElementValue(26, new hmh.sap.rfc.util.BapicondxType_List());
    ...
    public void setTextlines_Ex(hmh.sap.rfc.util.BapitextliType_List Textlines_Ex) {
        baseTypeData().setElementValue(13, Textlines_Ex);
    }

    
    public hmh.sap.rfc.util.BapictrxType_List get_as_listSales_Contract_Inx() {
        return (hmh.sap.rfc.util.BapictrxType_List)baseTypeData().getElementValue(24);
    }

    
    public hmh.sap.rfc.BapicondType[] getConditions_Ex() {
        hmh.sap.rfc.util.BapicondType_List i$ = (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(43);
        if ( i$ == null){return null;}
    ...
    public void setPartneraddresses(hmh.sap.rfc.Bapiaddr1Type[] Partneraddresses) {
        baseTypeData().setElementValue(38, new hmh.sap.rfc.util.Bapiaddr1Type_List());
    ...
    public void setSchedule_Ex(hmh.sap.rfc.BapisdheduType[] Schedule_Ex) {
        baseTypeData().setElementValue(15, new hmh.sap.rfc.util.BapisdheduType_List());
    ...
    public hmh.sap.rfc.BapicuvkType[] getSales_Cfgs_Vk() {
        hmh.sap.rfc.util.BapicuvkType_List i$ = (hmh.sap.rfc.util.BapicuvkType_List)baseTypeData().getElementValue(28);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.Bapiret2Type_List get_as_listReturn() {
        return (hmh.sap.rfc.util.Bapiret2Type_List)baseTypeData().getElementValue(36);
    }

    
    public void setSalesdocument(java.lang.String Salesdocument) {
        baseTypeData().setElementValue(7, Salesdocument);
    }
    ...
    public void setItems_Ex(hmh.sap.rfc.util.BapisditType_List Items_Ex) {
        baseTypeData().setElementValue(39, Items_Ex);
    }

    
    public hmh.sap.rfc.BapisditmxType[] getSales_Items_Inx() {
        hmh.sap.rfc.util.BapisditmxType_List i$ = (hmh.sap.rfc.util.BapisditmxType_List)baseTypeData().getElementValue(22);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdtehdType_List get_as_listTextheaders_Ex() {
        return (hmh.sap.rfc.util.BapisdtehdType_List)baseTypeData().getElementValue(14);
    }

    
    public hmh.sap.rfc.BapiparnrType[] getSales_Partners() {
        hmh.sap.rfc.util.BapiparnrType_List i$ = (hmh.sap.rfc.util.BapiparnrType_List)baseTypeData().getElementValue(20);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapicondType[] getSales_Conditions_In() {
        hmh.sap.rfc.util.BapicondType_List i$ = (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(27);
        if ( i$ == null){return null;}
        return  i$.toArrayBapicondType();
    }
    ...
    public void setSales_Keys(hmh.sap.rfc.BapisdkeyType[] Sales_Keys) {
        baseTypeData().setElementValue(21, new hmh.sap.rfc.util.BapisdkeyType_List());
    ...
    public hmh.sap.rfc.util.BapiincompType_List get_as_listIncomplete_Log() {
        return (hmh.sap.rfc.util.BapiincompType_List)baseTypeData().getElementValue(40);
    }

    
    public hmh.sap.rfc.BapicuprtType[] getSales_Cfgs_Part_Of() {
        hmh.sap.rfc.util.BapicuprtType_List i$ = (hmh.sap.rfc.util.BapicuprtType_List)baseTypeData().getElementValue(32);
        if ( i$ == null){return null;}
    ...
    public void setBusiness_Ex(hmh.sap.rfc.util.BapisdbusiType_List Business_Ex) {
        baseTypeData().setElementValue(44, Business_Ex);
    }

    
    public void setIncomplete_Log(hmh.sap.rfc.BapiincompType[] Incomplete_Log) {
        baseTypeData().setElementValue(40, new hmh.sap.rfc.util.BapiincompType_List());
    ...
    public hmh.sap.rfc.BapisdbusiType[] getBusiness_Ex() {
        hmh.sap.rfc.util.BapisdbusiType_List i$ = (hmh.sap.rfc.util.BapisdbusiType_List)baseTypeData().getElementValue(44);
        if ( i$ == null){return null;}
    ...
    public void setConditions_Ex(hmh.sap.rfc.BapicondType[] Conditions_Ex) {
        baseTypeData().setElementValue(43, new hmh.sap.rfc.util.BapicondType_List());
    ...
    public hmh.sap.rfc.util.BapicondType_List get_as_listConditions_Ex() {
        return (hmh.sap.rfc.util.BapicondType_List)baseTypeData().getElementValue(43);
    }

    
    public void setSales_Items_In(hmh.sap.rfc.util.BapisditmType_List Sales_Items_In) {
        baseTypeData().setElementValue(23, Sales_Items_In);
    }

    
    public hmh.sap.rfc.BapisdtehdType[] getTextheaders_Ex() {
        hmh.sap.rfc.util.BapisdtehdType_List i$ = (hmh.sap.rfc.util.BapisdtehdType_List)baseTypeData().getElementValue(14);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.BapisdheduType[] getSchedule_Ex() {
        hmh.sap.rfc.util.BapisdheduType_List i$ = (hmh.sap.rfc.util.BapisdheduType_List)baseTypeData().getElementValue(15);
        if ( i$ == null){return null;}
    ...
    public void setStatus_Buffer_Refresh(java.lang.String Status_Buffer_Refresh) {
        baseTypeData().setElementValue(11, Status_Buffer_Refresh);
    }

    
    public void setTestrun(java.lang.String Testrun) {
        baseTypeData().setElementValue(12, Testrun);
    }

    
    public hmh.sap.rfc.util.BapisdkeyType_List get_as_listSales_Keys() {
        return (hmh.sap.rfc.util.BapisdkeyType_List)baseTypeData().getElementValue(21);
    }
    ...
    public void setSales_Cfgs_Value(hmh.sap.rfc.util.BapicuvalType_List Sales_Cfgs_Value) {
        baseTypeData().setElementValue(29, Sales_Cfgs_Value);
    }

    
    public void setSales_Ccard(hmh.sap.rfc.util.BapiccardType_List Sales_Ccard) {
        baseTypeData().setElementValue(35, Sales_Ccard);
    }

    
    public hmh.sap.rfc.BapischdlType[] getSales_Schedules_In() {
        hmh.sap.rfc.util.BapischdlType_List i$ = (hmh.sap.rfc.util.BapischdlType_List)baseTypeData().getElementValue(19);
        if ( i$ == null){return null;}
    ...
    public void setSales_Partners(hmh.sap.rfc.util.BapiparnrType_List Sales_Partners) {
        baseTypeData().setElementValue(20, Sales_Partners);
    }

    
    public void setItems_Ex(hmh.sap.rfc.BapisditType[] Items_Ex) {
        baseTypeData().setElementValue(39, new hmh.sap.rfc.util.BapisditType_List());
    ...
    public hmh.sap.rfc.BapicucfgType[] getSales_Cfgs_Ref() {
        hmh.sap.rfc.util.BapicucfgType_List i$ = (hmh.sap.rfc.util.BapicucfgType_List)baseTypeData().getElementValue(31);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.util.BapisdheduType_List get_as_listSchedule_Ex() {
        return (hmh.sap.rfc.util.BapisdheduType_List)baseTypeData().getElementValue(15);
    }

    
    public void setSales_Cfgs_Ref(hmh.sap.rfc.BapicucfgType[] Sales_Cfgs_Ref) {
        baseTypeData().setElementValue(31, new hmh.sap.rfc.util.BapicucfgType_List());
    ...
    public void setSales_Schedules_Inx(hmh.sap.rfc.util.BapischdlxType_List Sales_Schedules_Inx) {
        baseTypeData().setElementValue(18, Sales_Schedules_Inx);
    }

    
    public hmh.sap.rfc.util.BapicuprtType_List get_as_listSales_Cfgs_Part_Of() {
        return (hmh.sap.rfc.util.BapicuprtType_List)baseTypeData().getElementValue(32);
    }

    
    public void setSales_Sched_Conf_In(hmh.sap.rfc.Bapischdl2Type[] Sales_Sched_Conf_In) {
        baseTypeData().setElementValue(17, new hmh.sap.rfc.util.Bapischdl2Type_List());
    ...
    public void setTextheaders_Ex(hmh.sap.rfc.BapisdtehdType[] Textheaders_Ex) {
        baseTypeData().setElementValue(14, new hmh.sap.rfc.util.BapisdtehdType_List());
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zwrapper_Sd_Salesorder_Create_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zwrapper_Sd_Salesorder_Create_Input parent) {
            this.parent = parent;
