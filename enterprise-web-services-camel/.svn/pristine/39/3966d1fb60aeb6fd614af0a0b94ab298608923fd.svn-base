...
public class Z_Rfc_Get_Cust_Substitutions_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Z_Rfc_Get_Cust_Substitutions_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Z_Rfc_Get_Cust_Substitutions_Output () {
    ...
    public hmh.sap.rfc.util.ZvmaterialsType_List get_as_listT_Materials() {
        return (hmh.sap.rfc.util.ZvmaterialsType_List)baseTypeData().getElementValue(1);
    }

    
    public MetaData metadataZ_Rfc_Get_Cust_Substitutions_Output() {
        return metadata;
    }
    ...
    public void setT_Custsub(hmh.sap.rfc.util.ZvcustsubType_List T_Custsub) {
        baseTypeData().setElementValue(2, T_Custsub);
    }

    
    public void setT_Custsub(hmh.sap.rfc.ZvcustsubType[] T_Custsub) {
        baseTypeData().setElementValue(2, new hmh.sap.rfc.util.ZvcustsubType_List());
    ...
    public hmh.sap.rfc.ZvcustsubType[] getT_Custsub() {
        hmh.sap.rfc.util.ZvcustsubType_List i$ = (hmh.sap.rfc.util.ZvcustsubType_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
    ...
    public hmh.sap.rfc.ZvmaterialsType[] getT_Materials() {
        hmh.sap.rfc.util.ZvmaterialsType_List i$ = (hmh.sap.rfc.util.ZvmaterialsType_List)baseTypeData().getElementValue(1);
        if ( i$ == null){return null;}
    ...
    public void setT_Materials(hmh.sap.rfc.util.ZvmaterialsType_List T_Materials) {
        baseTypeData().setElementValue(1, T_Materials);
    }

    
    public hmh.sap.rfc.util.ZvcustsubType_List get_as_listT_Custsub() {
        return (hmh.sap.rfc.util.ZvcustsubType_List)baseTypeData().getElementValue(2);
    }

    
    public void setT_Materials(hmh.sap.rfc.ZvmaterialsType[] T_Materials) {
        baseTypeData().setElementValue(1, new hmh.sap.rfc.util.ZvmaterialsType_List());
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Z_Rfc_Get_Cust_Substitutions_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Z_Rfc_Get_Cust_Substitutions_Output parent) {
            this.parent = parent;
