...
public class Z_Rfc_Get_Material_Detail_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Z_Rfc_Get_Material_Detail_Input (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Z_Rfc_Get_Material_Detail_Input () {
    ...
    public MetaData metadataZ_Rfc_Get_Material_Detail_Input() {
        return metadata;
    }
    ...
    public void setCust_Id(java.lang.String Cust_Id) {
        baseTypeData().setElementValue(0, Cust_Id);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Z_Rfc_Get_Material_Detail_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Z_Rfc_Get_Material_Detail_Input parent) {
            this.parent = parent;
