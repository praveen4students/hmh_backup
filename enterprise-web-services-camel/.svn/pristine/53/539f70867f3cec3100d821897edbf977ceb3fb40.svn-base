...
public class ZvmaterialsType extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  ZvmaterialsType () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    protected  ZvmaterialsType (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  ZvmaterialsType parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (ZvmaterialsType parent) {
            this.parent = parent;
