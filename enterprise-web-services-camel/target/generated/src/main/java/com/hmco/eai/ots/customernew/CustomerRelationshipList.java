 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.hmco.com/EAI/OTS/CustomerNew}customerRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "customerRelationshipList")
public class CustomerRelationshipList {

    protected List<CustomerRelationship> customerRelationship;
     ...
     * 
     */
    public List<CustomerRelationship> getCustomerRelationship() {
        if (customerRelationship == null) {
            customerRelationship = new ArrayList<CustomerRelationship>();
        }
