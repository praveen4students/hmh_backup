...
/**
 * <p>Java class for RevenueForecast complex type.
 * 
 ...
 *         &lt;element name="RevenueForecastHistories" type="{urn:enterprise.soap.sforce.com}QueryResult" minOccurs="0"/>
...
@XmlType(name = "RevenueForecast", propOrder = {
    "closed",
    "commit",
    "commitComment",
    "commitOverride",
...
public class RevenueForecastType
    extends SObjectType
{
    ...
    @XmlElement(name = "RevenueForecastHistories", nillable = true)
    protected QueryResult revenueForecastHistories;
    ...
    /**
     * Gets the value of the revenueForecastHistories property.
     * 
     * @return
     *     possible object is
     *     {@link QueryResult }
     *     
     */
    public QueryResult getRevenueForecastHistories() {
        return revenueForecastHistories;
    }

    /**
     * Sets the value of the revenueForecastHistories property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryResult }
     *     
     */
    public void setRevenueForecastHistories(QueryResult value) {
        this.revenueForecastHistories = value;
    }
