    ...
    extends SObjectType
{
    ...
    @XmlElement(name = "ApproveComment", nillable = true)
    ...
    protected ContractType parent;
    @XmlElement(name = "ParentId", nillable = true)
    protected String parentId;
    @XmlElement(name = "RequestComment", nillable = true)
     ...
     *     
     */
    public void setParent(ContractType value) {
        this.parent = value;
    }
