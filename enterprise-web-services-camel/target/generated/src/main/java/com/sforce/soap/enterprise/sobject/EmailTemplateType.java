    ...
    extends SObjectType
{
    ...
    @XmlElement(name = "BrandTemplateId", nillable = true)
    protected String brandTemplateId;
    ...
    @XmlElement(name = "TemplateStyle", nillable = true)
     ...
     *     
     */
    public void setBrandTemplateId(String value) {
