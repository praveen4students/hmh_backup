...
public class CaseContactRoleType
    extends SObjectType
{

    @XmlElement(name = "Cases", nillable = true)
    protected CaseType cases;
    @XmlElement(name = "CasesId", nillable = true)
    protected String casesId;
     ...
     *     
     */
    public void setCases(CaseType value) {
        this.cases = value;
    }
     ...
     *     
     */
    public void setCasesId(String value) {
        this.casesId = value;
    }
