...
public class UserAccountTeamMemberType
    extends SObjectType
{
    ...
    @XmlElement(name = "TeamMemberRole", nillable = true)
    protected String teamMemberRole;
     ...
     *     
     */
    public void setTeamMemberRole(String value) {
        this.teamMemberRole = value;
    }
