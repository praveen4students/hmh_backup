...
/**
 * <p>Java class for QuantityForecastHistory complex type.
 * 
 ...
 *         &lt;element name="ForecastOverride" type="{urn:sobject.enterprise.soap.sforce.com}QuantityForecast" minOccurs="0"/>
...
@XmlType(name = "QuantityForecastHistory", propOrder = {
    "closed",
    "commit",
    "commitComments",
    "commitOverridden",
...
public class QuantityForecastHistoryType
    extends SObjectType
{
    ...
    protected QuantityForecastType forecastOverride;
     ...
     * @return
     *     possible object is
     *     {@link QuantityForecastType }
     *     
     */
    public QuantityForecastType getForecastOverride() {
     ...
     *     
     */
    public void setForecastOverride(QuantityForecastType value) {
