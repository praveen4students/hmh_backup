...
public class OpportunityCompetitorType
    extends SObjectType
{

    @XmlElement(name = "CompetitorName", nillable = true)
    ...
    @XmlElement(name = "Strengths", nillable = true)
    protected String strengths;
    @XmlElement(name = "SystemModstamp", nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar systemModstamp;
    @XmlElement(name = "Weaknesses", nillable = true)
     ...
     *     
     */
    public void setWeaknesses(String value) {
